...
<html
  ...
  <head>
    ...
    <title>Register Mahasiswa | E-Lab Poliwangi</title>
    ...
    <link rel="stylesheet" href="<?php echo asset('vendor/css/theme-default.css'); ?>" class="template-customizer-theme-css" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?php echo asset('vendor/css/pages/page-auth.css'); ?>" />
