...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Edit Barang</h4>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="nama_barang" name="nama_barang"
                                    ...
                                    required value="{{ old('nama_barang', $barang->nama_barang) }}" />
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="id_kategori" name="id_kategori" required>
                                @foreach($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}" {{ $barang->id_kategori == $kategori->id ? 'selected' : '' }}>{{ $kategori->nama_kategori }}</option>
                                @endforeach
                            </select>
                        </div>
